...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and friendly matches for basketball players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Outdoor soccer training and weekend scrimmages",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["eva@mergington.edu", "leo@mergington.edu"]
    },
    "Art Club": {
